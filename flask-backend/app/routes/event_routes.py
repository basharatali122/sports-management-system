...
# event_bp.route('/getAllEvents', methods=['GET'])(get_all_events)
# event_bp.route('/getEventById/<event_id>', methods=['GET'])(get_event_by_id)
# event_bp.route('/getParticipantEvents', methods=['GET'])(get_participant_events)
