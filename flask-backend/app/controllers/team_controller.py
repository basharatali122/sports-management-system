...
#         # Format teams and populate references
#         formatted_teams = []
#         for team in teams:
...
#         return response_handler(error=f"Error fetching teams: {str(e)}", status_code=500)
...
#             'coach': ObjectId(request.user['_id']),
#             'createdBy': ObjectId(request.user['_id']),
#             'approved': False
#         }
...
#             team['_id'] = str(team['_id'])
#             formatted_teams.append(team)
#         return response_handler(data=formatted_teams)
#     except Exception as e:
#         return response_handler(error=f"Error fetching pending teams: {str(e)}", status_code=500)
...
#         return response_handler(data=formatted_teams)
#     except Exception as e:
#         return response_handler(error=f"Error fetching approved teams: {str(e)}", status_code=500)
...
#     except Exception as e:
#         return response_handler(error=f"Error approving team: {str(e)}", status_code=500)
...
#             return response_handler(error="Already a member", status_code=400)
...
#         return response_handler(error="Error joining team", status_code=500)
...
#     except Exception as e:
#         return response_handler(error=f"Error leaving team: {str(e)}", status_code=500)
...
#         if str(team.get('coach')) != request.user['_id']:
#             return response_handler(
...
#     except Exception as e:
#         return response_handler(error=f"Error updating team: {str(e)}", status_code=500)
...
#     except Exception as e:
#         return response_handler(error=f"Error deleting team: {str(e)}", status_code=500)
