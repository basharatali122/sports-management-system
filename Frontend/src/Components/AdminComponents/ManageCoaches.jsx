...
// import { Trash2, ShieldOff, ShieldCheck, Loader2, UserCog, Search } from "lucide-react";
...
//         `${BASE_URL}/admin/coaches/${coach._id}/block`,
//         {},
//         authHeader
//       );
//       const updated = res.data?.data;
//       if (updated) {
//         setCoaches((prev) => prev.map((c) => (c._id === coach._id ? updated : c)));
//       }
//       const isBlocked = updated?.accountStatus === "blocked";
//       toast.success(isBlocked ? "Coach blocked" : "Coach unblocked");
//     } catch {
...
//                 {confirmModal.type === "delete" ? "Delete Coach?" : confirmModal.coach.accountStatus === "blocked" ? "Unblock Coach?" : "Block Coach?"}
//               </h3>
//               <p className="text-sm text-gray-400 mb-5">
//                 {confirmModal.type === "delete"
//                   ? `Are you sure you want to permanently delete "${confirmModal.coach.name}"? This cannot be undone.`
...
//                   onClick={() =>
//                     confirmModal.type === "delete"
//                       ? handleDelete(confirmModal.coach)
//                       : handleBlock(confirmModal.coach)
//                   }
