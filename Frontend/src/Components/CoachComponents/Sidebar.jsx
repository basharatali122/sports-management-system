...
import { ThemeContext } from "../../context/ThemeContext";
import useUser from "../../context/UserContext";
import { Users, CalendarDays, Users2, MessageSquare, BarChart3, UserCheck, Send } from "lucide-react";

const navItems = [
  { label: "Create Events",    path: "/coach-dashboard/create-events",  icon: <CalendarDays size={18} /> },
  { label: "Create Teams",     path: "/coach-dashboard/create-teams",   icon: <Users2 size={18} /> },
  { label: "Reports",          path: "/coach-dashboard/reports",        icon: <BarChart3 size={18} /> },
  { label: "Manage Participants", path: "/coach-dashboard/view-users",  icon: <Users size={18} /> },
  { label: "Participants",     path: "/coach-dashboard/participants",   icon: <UserCheck size={18} /> },
  { label: "Invite to Events", path: "/coach-dashboard/event-invites", icon: <Send size={18} /> },
];
