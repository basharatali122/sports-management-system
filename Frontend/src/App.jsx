...
import CoachParticipants from "./Components/CoachComponents/CoachParticipants";
import CoachEventInvite  from "./Components/CoachComponents/CoachEventInvite";
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={["coach"]} />}>
            <Route path="/coach-dashboard" element={<CoachDashboard />}>
              ...
              <Route path="event-invites"  element={<CoachEventInvite />} />
